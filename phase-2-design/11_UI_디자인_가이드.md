...
## 2. 목적
특허·법무·R&D 협업에 적합한 고밀도 업무형 UI 원칙을 정의한다.
...
## 5. UI 원칙
- 정보밀도 우선: 표/필터/분할패널 중심
- Evidence-first: 판단 옆에 항상 근거 링크
- Revision-aware: 설계/Claim 버전 고정 노출
- Risk-aware: Critical/High/Medium/Low + 아이콘/텍스트
- Human-in-the-loop: AI 결과는 초안/추천으로 표시
- Audit-friendly: 승인자/일시/변경이력 빠른 접근
- Accessible: 키보드 탐색, WCAG 2.1 AA 목표

### 페이지 그리드
- 좌 240px Navigation
- 상 56px Global header
- 본문 12-column
- Detail drawer 420~520px
