      ...
      <div className="workspace-grid">
        ...
        <aside className="workspace-right" aria-label="Gate 판정">
          <section className="workspace-card gate-card">
            ...
            <div className="gate-meter"><div className="donut" style={{ '--progress': `${meta.readiness}%` } as React.CSSProperties}><strong>{meta.readiness}</strong><span>%</span></div><div><strong>{checked.filter(Boolean)} / {checked.length}</strong><p>체크리스트 충족</p></div></div>
