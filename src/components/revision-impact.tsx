...
export function RevisionImpact({ projectId, revisionId, version, readOnly }: { projectId: string; revisionId: string; version: number; readOnly: boolean }) {
  ...
  return <main id="main-content" className="detail-page" tabIndex={-1}>
    ...
    <div className="revision-summary"><div><small>현재 revision</small><strong>R03</strong><span>2026.08.21 동결</span></div><span aria-hidden="true">→</span><div><small>변경 예정</small><strong>R04</strong><span>ECO-2026-081</span></div><div className="revision-risk"><span className="risk-chip">HIGH 영향</span><strong>Gate 2개 재검토 필요</strong><p>설계·시험 Gate가 R03 근거에 연결되어 있습니다.</p></div></div>
